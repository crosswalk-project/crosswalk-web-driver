...
#ifndef XWALK_TEST_XWALKDRIVER_XWALK_DEVICE_BRIDGE_H_
#define XWALK_TEST_XWALKDRIVER_XWALK_DEVICE_BRIDGE_H_
...
class DeviceBridge {
 public:
  ...
  virtual Status ForwardPort(const std::string& device_serial,
                             int local_port,
                             const std::string& remote_port) = 0;
...
#endif  // XWALK_TEST_XWALKDRIVER_XWALK_DEVICE_BRIDGE_H_
