{
  'variables': {
    'xwalk_automation_client_lib_sources': [
      'test/xwalkdriver/xwalk/adb.h',
      'test/xwalkdriver/xwalk/adb_impl.cc',
      'test/xwalkdriver/xwalk/adb_impl.h',
      'test/xwalkdriver/xwalk/automation_extension.cc',
      'test/xwalkdriver/xwalk/automation_extension.h',
      ...
      'test/xwalkdriver/xwalk/xwalk_remote_impl.cc',
      'test/xwalkdriver/xwalk/xwalk_remote_impl.h',
      ...
      'test/xwalkdriver/xwalk/device_metrics.cc',
      'test/xwalkdriver/xwalk/device_metrics.h',
      ...
      'test/xwalkdriver/xwalk/mobile_device.cc',
      'test/xwalkdriver/xwalk/mobile_device.h',
      'test/xwalkdriver/xwalk/mobile_device_list.cc',
      'test/xwalkdriver/xwalk/mobile_device_list.h',
      'test/xwalkdriver/xwalk/mobile_emulation_override_manager.cc',
      'test/xwalkdriver/xwalk/mobile_emulation_override_manager.h',
      'test/xwalkdriver/xwalk/navigation_tracker.cc',
      'test/xwalkdriver/xwalk/navigation_tracker.h',
      'test/xwalkdriver/xwalk/network_conditions.cc',
      'test/xwalkdriver/xwalk/network_conditions.h',
      'test/xwalkdriver/xwalk/network_conditions_override_manager.cc',
      'test/xwalkdriver/xwalk/network_conditions_override_manager.h',
      'test/xwalkdriver/xwalk/network_list.cc',
      'test/xwalkdriver/xwalk/network_list.h',
    ...
    'xwalk_driver_lib_sources': [
      '../third_party/webdriver/atoms.cc',
      '../third_party/webdriver/atoms.h',
#      'common/xwalk_constants.cc',
      'test/xwalkdriver/xwalk_constants.h',
      'test/xwalkdriver/xwalk_constants.cc',
      ...
      'test/xwalkdriver/xwalk/browser_info.cc',
      'test/xwalkdriver/xwalk/browser_info.h',
      'test/xwalkdriver/xwalk_launcher.cc',
      'test/xwalkdriver/xwalk_launcher.h',
      'test/xwalkdriver/command.h',
      'test/xwalkdriver/command_listener.h',
      'test/xwalkdriver/command_listener_proxy.cc',
      'test/xwalkdriver/command_listener_proxy.h',
      ...
      'test/xwalkdriver/keycode_text_conversion_ozone.cc',
      'test/xwalkdriver/keycode_text_conversion_x.cc',
      'test/xwalkdriver/logging.cc',
      'test/xwalkdriver/logging.h',
      'test/xwalkdriver/performance_logger.cc',
      'test/xwalkdriver/performance_logger.h',
    ...
    'xwalk_driver_unittests_sources': [
      ...
      'test/xwalkdriver/xwalk/mobile_emulation_override_manager_unittest.cc',
      'test/xwalkdriver/xwalk/navigation_tracker_unittest.cc',
      'test/xwalkdriver/xwalk/network_conditions_override_manager_unittest.cc',
      'test/xwalkdriver/xwalk/recorder_devtools_client.cc',
      'test/xwalkdriver/xwalk/recorder_devtools_client.h',
      ...
      'test/xwalkdriver/command_listener_proxy_unittest.cc',
      'test/xwalkdriver/commands_unittest.cc',
      'test/xwalkdriver/logging_unittest.cc',
      'test/xwalkdriver/performance_logger_unittest.cc',
    ...
    'xwalk_driver_tests_sources': [
      'test/xwalkdriver/key_converter_unittest.cc',
      'test/xwalkdriver/keycode_text_conversion_unittest.cc',
      'test/xwalkdriver/net/net_util_unittest.cc',
      'test/xwalkdriver/net/port_server_unittest.cc',
      'test/xwalkdriver/net/sync_websocket_impl_unittest.cc',
      'test/xwalkdriver/net/test_http_server.cc',
      'test/xwalkdriver/net/test_http_server.h',
      'test/xwalkdriver/net/websocket_unittest.cc',
      'test/xwalkdriver/test_util.cc',
      'test/xwalkdriver/test_util.h',
    ],
  },
  'targets': [
    {
    ...
    {
      # GN version: //xwalk/test/xwalkdriver
    ...
    {
      # GN version: //xwalk/test/xwalkdriver:xwalkdriver_unittests
    ...
    # xwalkDriver tests that aren't run on the main buildbot. Available
    # as an optional test type on trybots.
    {
      # GN version: //xwalk/test/xwalkdriver:xwalkdriver_tests
      'target_name': 'xwalkdriver_tests',
      'type': 'executable',
      'dependencies': [
        'xwalkdriver_lib',
        '../base/base.gyp:base',
    ...
    {
      # GN version: //xwalk/test/xwalkdriver:lib
      ...
      'actions': [
        {
          # GN version: //xwalk/test/xwalkdriver:embed_version_in_cpp
    ...
    {
      # GN version: //xwalk/test/xwalkdriver:automation_client_lib
      ...
      'sources': [
        '<@(xwalk_automation_client_lib_sources)',
        '<(SHARED_INTERMEDIATE_DIR)/xwalk/test/xwalkdriver/xwalk/embedded_automation_extension.cc',
        '<(SHARED_INTERMEDIATE_DIR)/xwalk/test/xwalkdriver/xwalk/embedded_automation_extension.h',
      ...
      'actions': [
        {
          # GN version: //xwalk/test/xwalkdriver:embed_js_in_cpp
        ...
        {
          # GN version: //xwalk/test/xwalkdriver:embed_user_data_dir_in_cpp
        ...
        {
          # GN version: //xwalk/test/xwalkdriver:embed_extension_in_cpp
          'action_name': 'embed_extension_in_cpp',
          'inputs': [
            'test/xwalkdriver/cpp_source.py',
            'test/xwalkdriver/embed_extension_in_cpp.py',
            'test/xwalkdriver/extension/background.js',
            'test/xwalkdriver/extension/manifest.json',
          ],
          'outputs': [
            '<(SHARED_INTERMEDIATE_DIR)/xwalk/test/xwalkdriver/xwalk/embedded_automation_extension.cc',
            '<(SHARED_INTERMEDIATE_DIR)/xwalk/test/xwalkdriver/xwalk/embedded_automation_extension.h',
